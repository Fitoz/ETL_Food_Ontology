...
public class test1  {
	...
	public test1(String inputFilename, String outputFilename) throws XMLStreamException, FileNotFoundException {
	...
	public void parseAndWrite() throws XMLStreamException, FileNotFoundException {
		...
		while(this.reader.hasNext()) {
			...
			if( tagname.equals( "title" ) ) {
				...
				titleElement.setPrefix( "rdfs" );
				titleElement.setUri( rdfsUri );
				titleElement.setElementName( "label" );
			...
			if( tagname.equals( "id" ) ) {
				...
				/* esta url es v�lida para dato en alojados en Biblioteca Digital, en caso de utilizar
			...
			if( tagname.equals( "field" ) ) {
				...
				/* Acepta lenguajes espa�ol e ingl�s, modificar en caso de necesitar agregar m�s idiomas */
                        /*
